...
shinyUI(# shinybootstrap2::withBootstrap2({
  tagList(
    useShinyjs(),
    navbarPage(
      "SMARTsize",
      ...
      header = tagList(
        ...
        tags$script(
          HTML(
            "$(document).ready(function(){$('.version').text('SMARTsize Version 1.2, last updated 29 July 2016');});"
          )
        ),
        tags$script(HTML(
          paste(
            "$(document).ready(function(){$('.Rversion').text('",
      ...
      tabPanel("Home",
               fluidRow(column(
                 ...
                 tags$div(
                   class = "page-header",
                   tags$h1(
                     "SMARTsize: A Sample Size Calculator for SMARTs with Binary or Continuous Outcomes"
                   )
                 )
               )),
               fluidRow(
                 ...
                 column(
                   ...
                   # mainPanel(
                   p(
                     "Get started by choosing whether you'd like to design a SMART from scratch, or
                   ...
                   tags$ol(
                     tags$li(
                       HTML(
                         "Oetting, A., Levy, J., Weiss, R. and Murphy, S. (2007)<I>, &quot;Statistical methodology for a SMART design in the development of adaptive treatment strategies
                     ...
                     tags$li(
                       "Nahum-Shani, I., Qian, M., Almirall, D., Pelham, W. E., Gnagy, B., Fabiano, G. A., Waxmonsky, J. G., Yu, J. and Murphy, S. A. (2012),
                                          ''Experimental design and primary data analysis methods for comparing adaptive interventions.''",
                       em("Psychological methods,"),
                       "17, 457."
                     )
                   ),
      ...
      tabPanel(
        ...
        fluidRow(column(
          ...
          hidden(
            bsButton(
              inputId = "unlockDYO",
              label = "Unlock Disabled Sections",
              style = "warning",
              icon = icon("unlock-alt")
            )
          )
        ...
        fluidRow(column(
          ...
          tags$div(id = "stickyPanel",
                   jqui_resizable(
                     DiagrammeROutput("dyo.diagram", height = "600px")
                   ))
        ),
        column(
          7,
          ...
          tabsetPanel(
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    conditionalPanel(condition = 'input["dyo.stage1.eqrand"] == "No"',
                                     list(
                                       p("What are the allocation probabilities?"),
                                       fluidRow(column(
                                         11, uiOutput("dyo.stage1.rprobUI"), offset = 1
                                       ))
                                     ))
                  )
                ),
                fluidRow(
                  backButton("stage1.back"),
            ...
            tabPanel(
              ...
              tags$div(
                ...
                column(
                  6,
                  uiOutput("dyo.stage1.resprobUI"),
                  checkboxInput(
                    "conservative",
                    HTML(
                      "Compute <strong>conservative</strong> estimates of sample size."
                    )
                  )
                )),
              ...
              tags$div(
                ...
                fluidRow(
                  column(
                    ...
                    conditionalPanel(
                      condition = 'input["dyo.rerand.resp"] == "Yes"',
                      list(
                        uiOutput("dyo.rerand.respUI"),
                        sliderInput(
                          "dyo.rerand.resp.ntxt",
                        ...
                        conditionalPanel(condition = 'input["dyo.rerand.resp.eqrand"]  == "No"',
                                         list(
                                           p("What are the allocation probabilites?"),
                                           fluidRow(column(
                                             11, uiOutput("dyo.rerand.resp.rprobUI"), offset = 1
                                           ))
                                         ))
                      )
                    )
                  ...
                  column(
                    ...
                    conditionalPanel(
                      condition = 'input["dyo.rerand.nresp"] == "Yes"',
                      list(
                        uiOutput("dyo.rerand.nrespUI"),
                        sliderInput(
                          "dyo.rerand.nresp.ntxt",
                        ...
                        conditionalPanel(condition = 'input["dyo.rerand.nresp.eqrand"] == "No"',
                                         list(
                                           p("What are the allocation probabilities?"),
                                           fluidRow(column(
                                             11, uiOutput("dyo.rerand.nresp.rprobUI"), offset = 1
                                           ))
                                         ))
                      )
                    )
          ...
          tags$div(
            ...
            tabsetPanel(
              ...
              tabPanel(
                ...
                tags$div(
                  ...
                  conditionalPanel(
                    ...
                    fluidRow(column(
                      6, checkboxInput("stage1omnibus", "Test")
                    ))
                  ),
                  conditionalPanel(
              ...
              tabPanel(
                ...
                tags$div(
                  class = "card",
                  h2("Describe your Estimated Effect"),
                  tags$hr(),
                  conditionalPanel(
