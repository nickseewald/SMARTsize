HTML("
	<ol>
		<li> Almirall, D., Compton, S. N., Gunlicks-Stoessel, M., Duan, N. and Murphy, S. A. (2012), &quot;Designing a pilot sequential multiple assignment randomized trial for developing an adaptive treatment strategy,&quot;<I> Statistics in medicine </I>, 31, 1887-1902.
		<li> Auyeung, S. F., Long, Q., Royster, E. B., Murthy, S., McNutt, M. D., Lawson, D., Miller, A., Manatunga, A. and Musselman, D. L. (2009), &quot;Sequential multiple-assignment randomized trial design of neurobehavioral treatment for patients with metastatic malignant melanoma undergoing high-dose interferon-alpha therapy,&quot;<I> Clinical trials (London, England) </I>, 6, 480-490. 
		<li> Bembom, O. and van der Laan, Mark J. (2008), &quot;Analyzing sequentially randomized trials based on causal effect models for realistic individualized treatment rules,&quot;<I> Statistics in medicine </I>, 27, 3689-3716.
		<li> Bembom, O. and van der Laan, M. J. (2007), &quot;Statistical methods for analyzing sequentially randomized trials,&quot;<I> Journal of the National Cancer Institute </I>, 99, 1577-1582. 
		<li> Buyze, J. and Goetghebeur, E. (2013), &quot;Evaluating dynamic treatment strategies: does it have to be more costly?&quot;<I> Pharmaceutical statistics </I>, 12, 35-42.
		<li> Buyze, J., Van Rompaye, B. and Goetghebeur, E. (2010), &quot;Designing a sequentially randomized study with adherence enhancing interventions for diabetes patients,&quot;<I> Statistics in medicine </I>, 29, 1114-1126.
		<li> Chakraborty, B. and Murphy, S. A. (2014), &quot;Dynamic treatment regimes,&quot;<I> Annual Review of Statistics and its Application </I>, 1, 447-464.
		<li> Chakraborty, B. (2011), &quot;Dynamic Treatment Regimes for Managing Chronic Health Conditions: A Statistical Perspective,&quot; <I> Am J Public Health </I>, 101, 40-45.
		...
		<li> Dawson, R. and Lavori, P. W. (2004), &quot;Placebo-free designs for evaluating new mental health treatments: the use of adaptive treatment strategies,&quot;<I> Statistics in medicine </I>, 23, 3249-3262.
		<li> Dawson, R. and Lavori, P. W. (2010), &quot;Sample size calculations for evaluating treatment policies in multi-stage designs,&quot;<I> Clinical trials (London, England) </I>, 7, 643-652.
		<li> Feng, W. and Wahed, A. S. (2009), &quot;Sample size for two-stage studies with maintenance therapy,&quot;<I> Statistics in medicine </I>, 28, 2028-2041.
		<li> Feng, W. and Wahed, A. S. (2008), &quot;Supremum weighted log-rank test and sample size for comparing two-stage adaptive treatment strategies, &quot;<I> Biometrika </I>, 95, 695-707.
